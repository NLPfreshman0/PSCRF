...
Date: 2024-01-11 15:47:45
LastEditors: wuyongyu wuyongyu@atomecho.xyz
LastEditTime: 2024-01-29 21:30:50
FilePath: /zjq/zhangdacao/pisa/EduCDM/EduCDM/IRT/GD/train.py
...
model.train(train_data=train_loader, test_data=val_loader, epoch=100, device="cuda:0", lr=0.001, method=args.method, sensitive_name=args.sensitive_name)