...
LastEditTime: 2024-02-03 17:39:19
...
if os.path.exists(save_path) and os.path.isdir(save_path) and os.listdir(save_path):
    ...
    os.makedirs(save_path)
model = MIRT(user_num=user_num, item_num=item_num, latent_dim=68, save_path=save_path, sensitive_name=args.sensitive_name, dataset_index=args.dataset_index, mode=args.mode)
