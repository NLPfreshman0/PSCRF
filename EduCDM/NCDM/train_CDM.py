...
if os.path.exists(save_path) and os.path.isdir(save_path) and os.listdir(save_path):
    ...
    os.makedirs(save_path)
model = NCDM(knowledge_n=68, exer_n=item_num, student_n=user_num, save_path=save_path, sensitive_name=args.sensitive_name, dataset_index=args.dataset_index, mode=args.mode)
